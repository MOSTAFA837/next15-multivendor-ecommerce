  ...
  return (
    <div className="bg-gradient-to-r from-gray-100 to-gray-200 p-5">
      <div className="max-w-[1430px] mx-auto">
        <div className="flex flex-col gap-y-4 xl:flex-row items-center ">
          {/* Left */}
          ...
          <div className="flex w-full xl:flex-1">
            ...
            />
            <span className="h-10 w-24 text-sm grid place-content-center rounded-r-full bg-blue-700 text-white cursor-pointer">
              Sign up
            </span>
          </div>
        </div>
